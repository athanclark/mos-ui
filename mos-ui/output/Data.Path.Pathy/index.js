...
var unsandbox = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Path.Pathy line 353, column 1 - line 353, column 62: " + [ v.constructor.name ]);
};
...
var refine = function (f) {
    return function (d) {
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.Path.Pathy line 466, column 9 - line 466, column 37: " + [ v.constructor.name ]);
        };
        return go;
    };
};
...
var maybeRel = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Path.Pathy line 322, column 1 - line 322, column 61: " + [ v.constructor.name ]);
};
var maybeDir = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Path.Pathy line 306, column 1 - line 306, column 61: " + [ v.constructor.name ]);
};
var maybeAbs = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Path.Pathy line 330, column 1 - line 330, column 61: " + [ v.constructor.name ]);
};
var isAbsolute = function ($copy_v) {
    var $tco_done = false;
    var $tco_result;
    function $tco_loop(v) {
        if (v instanceof Current) {
        ...
        throw new Error("Failed pattern match at Data.Path.Pathy line 278, column 1 - line 278, column 50: " + [ v.constructor.name ]);
    };
    while (!$tco_done) {
...
var depth = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Path.Pathy line 339, column 1 - line 339, column 41: " + [ v.constructor.name ]);
};
...
var maybeFile = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Path.Pathy line 314, column 1 - line 314, column 63: " + [ v.constructor.name ]);
};
