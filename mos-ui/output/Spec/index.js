...
var main = function __do() {
    ...
    var v1 = Queue_Internal.newQueue();
    var v2 = Queue_Internal.newQueue();
    var v3 = Queue_Internal.newQueue();
    Electron_Renderer.registerAsyncHandler({
        ...
        handle: function (v4) {
            ...
            if (v5 instanceof Data_Either.Right) {
                return Queue_Internal.putQueue(v1)(new IpcAction(new Types_DBus.ControlOutput(v5.value0)));
            };
            throw new Error("Failed pattern match at Spec line 213, column 9 - line 216, column 64: " + [ v5.constructor.name ]);
        }
    })();
    Electron_Renderer.registerAsyncHandler({
        ...
        handle: function (v4) {
            ...
            if (v5 instanceof Data_Either.Right) {
                return Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(function (x) {
                    return Queue_Internal.putQueue(v2)(new IpcAction(new Types_DBus.SignalOutput(x)));
                })(v5.value0);
            };
            throw new Error("Failed pattern match at Spec line 222, column 9 - line 225, column 83: " + [ v5.constructor.name ]);
        }
    })();
    Electron_Renderer.registerAsyncHandler({
        ...
        handle: function (v4) {
            ...
            if (v5 instanceof Data_Either.Right) {
                return Queue_Internal.putQueue(v3)(v5.value0);
            };
            throw new Error("Failed pattern match at Spec line 231, column 9 - line 234, column 32: " + [ v5.constructor.name ]);
        }
    })();
    ...
    return Queue_Internal.onQueue(v3)(function (env) {
        return function __do() {
            var v4 = Control_Monad_Eff_Exception["try"]((function () {
                ...
                var reactSpec$prime = (function () {
                    ...
                    $114.componentDidMount = function ($$this) {
                        return function __do() {
                            Control_Monad_Eff_Unsafe.unsafeCoerceEff(Queue_Internal.onQueue(v2)(function ($130) {
                                return Control_Monad_Eff_Unsafe.unsafeCoerceEff(v4.dispatcher($$this)($130));
                            }))();
                            Control_Monad_Eff_Unsafe.unsafeCoerceEff(Queue_Internal.onQueue(v1)(function ($131) {
                                return Control_Monad_Eff_Unsafe.unsafeCoerceEff(v4.dispatcher($$this)($131));
                            }))();
                ...
                return function __do() {
                    Control_Bind.bindFlipped(Control_Monad_Eff.bindEff)(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(function ($132) {
                        return ReactDOM.render(React.createFactory(component)(Data_Unit.unit))(DOM_HTML_Types.htmlElementToElement($132));
                    ...
                    var resolve = function (v5) {
                        ...
                        throw new Error("Failed pattern match at Spec line 254, column 11 - line 254, column 43: " + [ v5.constructor.name ]);
                    };
            ...
            throw new Error("Failed pattern match at Spec line 271, column 5 - line 273, column 23: " + [ v4.constructor.name ]);
        };
    })();
};
module.exports = {
